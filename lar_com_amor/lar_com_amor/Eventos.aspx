...
<head runat="server">
    ...
    <title>Lar com amor | Eventos</title>
            ...
            <section class="limiter flex alignCenter justBetween">
                ...
                <section id="campo-navegacao" class="flex justEnd alignCenter">
                    <nav ativo="false">
                        ...
                        <a href="./eventos.aspx" ativo="true">Eventos</a>
            ...
            <article class="content-box flex alignEnd" id="campo-pesquisa">
                ...
                <div class="grid4">
                    <div class="itemForm">
                        ...
                        <asp:DropDownList ID="ddlTipoEvento" runat="server" CssClass="itemForm" AutoPostBack="true">
                        </asp:DropDownList>
                    </div>
                    <div class="itemForm">
                        <label for="selEstado">Estado</label>
                        <asp:DropDownList ID="ddlEstado" runat="server" CssClass="itemForm" AutoPostBack="true">
                        </asp:DropDownList>
                    </div>
                    <div class="itemForm">
