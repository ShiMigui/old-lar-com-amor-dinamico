<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v1_forms.aspx.cs" Inherits="lar_com_amor.forms" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <main class="forms">
            <article id="perguntas" class="full-width">
                <asp:Literal runat="server" ID="litPerguntas" Text=""></asp:Literal>
            </article>

            <section class="flex justCenter">
                <asp:Button ID="btnAddPergunta" Visible="false"  runat="server" Text="Nova pergunta" OnClick="btnAddPergunta_Click"/>
                <asp:Button ID="btnSalvar" Visible="false"  runat="server" Text="Salvar alterações"/>
